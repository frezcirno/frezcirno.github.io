...
![](lex/nfa_dfa_example_1.png)

![](lex/nfa_dfa_example_2.png)
...
将$\{A,B,C,D\}$分成$\{A,B,C\}$和$\{D\}$, 得$\Pi_1=\{\{A,B,C\},\{D\},\{E\}\}$

考察$\{A,B,C\}_b=\{C,D\}$, 需要划分, 其中$\{A,C\}_b=\{C\}$, $\{B\}_b=\{D\}$

将$\{A,B,C\}$分为$\{A,C\}$和$\{B\}$, 得$\Pi_2=\{\{A,C\},\{B\},\{D\},\{E\}\}$
